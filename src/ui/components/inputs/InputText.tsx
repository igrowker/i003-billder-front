...
export const InputText = ({
  ...
  const finalStyle = (variant === InputStyles.Normal) ? normalStyle : outlinedBlackStyle
  ...
  return (
    <div className="relative">
      ...
      <span className={`${hasErrors ? 'text-red-500' : ''} absolute top-[110%]  w-[calc(100%-4px)] text-xs select-none text-gray-600 left-1`}>{supportText}</span>
    </div>
